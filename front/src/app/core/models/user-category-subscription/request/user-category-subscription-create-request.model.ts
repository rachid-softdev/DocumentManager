...
export class UserCategorySubscriptionCreateRequest implements Serialize<object>, Deserialize<string> {
  ...
  toString(): string {
    return `UserCategoryCreateRequest [user=${this.getUser?.getEmail ?? ''}, category=${
