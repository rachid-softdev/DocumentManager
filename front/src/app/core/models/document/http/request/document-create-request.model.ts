...
export class DocumentCreateRequest implements Serialize<object>, Deserialize<string> {
  ...
  serialize(): object {
    return {
      ...
      validator_user: this.getValidatorUser,
  ...
  toString(): string {
    return `DocumentCreateRequest [title=${this.getTitle}, description=${this.getDescription}, sender_user=${this.getSenderUser?.getEmail}, is_validated=${this.getIsValidated}, validator_user=${this.getValidatorUser?.getEmail}, validated_at=${this.getValidatedAt}]`;
  }
}
