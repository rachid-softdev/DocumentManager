...
export class CategoryCreateRequest implements Serialize<object>, Deserialize<string> {
  ...
  public deserialize(input: any): string {
    return Object.assign(this, input);
  }

  public toString(): string {
    return `CategoryCreateRequest [name=${this._name}, description=${this._description}, parent_category_id=${this._parentCategoryId}]`;
  }
}
